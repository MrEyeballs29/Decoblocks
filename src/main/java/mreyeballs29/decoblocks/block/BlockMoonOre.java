...
public class BlockMoonOre extends Block {
	...
	public BlockMoonOre(Material material, String name, String toolClass, int level) {
		super(material);
	...
	public IIcon[] icons = new IIcon[Names.ORES.length];
	
	@Override
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < icons.length; i++) {
			this.icons[i] = reg.registerIcon(this.textureName + "_" + Names.ORES[i]);
		}
	}
