...
public class BlockMarsSpecial extends Block {

	protected BlockMarsSpecial(Material material, String name, String toolClass, int level) {
		super(material);
	...
	public void registerBlockIcons(IIconRegister reg) {
		for (int i = 0; i < icons.length; i++) {
			this.icons[i] = reg.registerIcon(this.textureName + "_" + Names.MARS_TYPES[i]);
		}
	}
