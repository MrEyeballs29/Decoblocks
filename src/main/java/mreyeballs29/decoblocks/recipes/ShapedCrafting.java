...
public final class ShapedCrafting {
	public static final void init() {
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.specialstone, 4, 2), new Object[] {"BA", "AB", 'A', new ItemStack(Blocks.stonebrick, 1, 0), 'B', new ItemStack(ModBlocks.specialstone, 1, 0)});
